                ...
                <span className="relative">
                  ...
                  <span
                    className="
                      ...
                      h-[2px]
                      w-0
                      bg-gradient-to-r from-[#E07A4F] to-[#ff9e75]
                      transition-all
                      duration-300
                      group-hover:w-full
                      shadow-[0_0_8px_rgba(224,122,79,0.8)]
                    "
                  />
                </span>
              </Link>
            ...
            <div className="flex h-full flex-col justify-center px-8 relative z-10">
                  ...
                  >
                    <Link
                      ...
                      className="
                        ...
                        font-bold
                        tracking-tight
                        text-transparent bg-clip-text bg-gradient-to-r from-[#F5F1EB] to-[#B9B4AD]
                        transition-all
                        hover:from-[#E07A4F] hover:to-[#ff9e75]
                      "
                    >
                      {item.name}
                    </Link>
              ...
              <motion.button
                ...
                className="
                  ...
                  font-medium
                  text-white
                  shadow-[0_0_20px_rgba(224,122,79,0.2)]
                "
              >
                Start Project
              </motion.button>
