export default function Loading() {
  return (
    <div className="fixed inset-0 z-[9999] overflow-hidden bg-[#0D0D0D] animate-[wipeUp_1s_cubic-bezier(.76,0,.24,1)_3s_forwards]">
      {/* Film Texture */}
      ...
      <div className="relative flex h-full flex-col items-center justify-center px-6 text-center">
        <div className="relative overflow-hidden">
          <h1 className="animate-[fadeUp_.8s_ease_forwards] text-5xl font-bold tracking-[-0.06em] text-[#F5F1EB] md:text-8xl">
            Scene Banega{" "}
            <span className="relative text-[#E07A4F]">
              Kya?
              <span className="pointer-events-none absolute inset-0 overflow-hidden">
                <span className="absolute -left-20 top-0 h-full w-10 skew-x-[-20deg] bg-gradient-to-r from-transparent via-white/70 to-transparent animate-[shimmer_2s_linear_infinite]" />
              </span>
            </span>
          </h1>
        </div>
        ...
        <div className="relative mt-10 h-[3px] w-72 overflow-hidden rounded-full bg-white/10">
          ...
          <div className="absolute inset-0">
            <div className="absolute -left-12 h-full w-12 bg-gradient-to-r from-transparent via-white to-transparent blur-sm animate-[shimmer_1.2s_linear_infinite]" />
          </div>
        </div>
      </div>

      {/* Curved Bottom */}
      <div className="pointer-events-none absolute -bottom-44 left-0 h-[340px] w-full rounded-t-[100%] bg-[#0D0D0D] animate-[curve_1s_cubic-bezier(.76,0,.24,1)_3s_forwards]" />
    </div>
  );
}